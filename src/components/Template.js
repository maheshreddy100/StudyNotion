...
const Template = ({title, desc1, desc2, image, formtype, setIsLoggedIn}) => {
    ...
    return (
        ...
        <div className='w-11/12 max-w-[450px]'>
            ...
            >{title}</h1>
            <p className="text-[1.2rem] leading-[1.6rem] mt-4">
            ...
            <div className="flex w-full items-center my-4 gap-x-4">
                ...
                <p className="text-richblack-700 font-medium line-[1.375rem]">OR</p>
                <div className="h-[1px] w-full bg-richblack-700" ></div>
            </div>

            <button className=" w-full flex justify-center items-center
            rounded-md font-medium border border-richblack-700
            px-[12px] py-[8px] gap-x-2 mt-6">
                <FcGoogle />
                <p className=" text-richblack-200">Signup With Google</p>
            </button>
        </div>
